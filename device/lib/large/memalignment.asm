...
;------------------------------------------------------------
;p                         Allocated with name '_memalignment_p_65536_39'
;ip                        Allocated with name '_memalignment_ip_65536_40'
;------------------------------------------------------------
...
_memalignment:
	...
	mov	r6,dph
	mov	a,dpl
	mov	dptr,#_memalignment_p_65536_39
	movx	@dptr,a
	mov	a,r6
	inc	dptr
	movx	@dptr,a
