...
_ser_rxBuffer::
	.ds 256
_ser_putc_c_65536_17:
	.ds 1
_ser_getc_tmp_65536_22:
	.ds 1
_ser_printString_String_65536_25:
	.ds 3
_ser_charAvail_ret_65536_29:
	.ds 1
;--------------------------------------------------------
...
;------------------------------------------------------------
;c                         Allocated with name '_ser_putc_c_65536_17'
;------------------------------------------------------------
...
;------------------------------------------------------------
;tmp                       Allocated with name '_ser_getc_tmp_65536_22'
;------------------------------------------------------------
...
;	_ser.c:154: tmp = ser_rxBuffer[ser_rxIndexOut++];
	...
	movx	a,@dptr
	mov	r7,a
	mov	dptr,#_ser_getc_tmp_65536_22
	movx	@dptr,a
	sjmp	00103$
00102$:
;	_ser.c:157: tmp = 0;
...
;------------------------------------------------------------
;String                    Allocated with name '_ser_printString_String_65536_25'
;------------------------------------------------------------
...
_ser_printString:
	...
	mov	r6,dph
	mov	a,dpl
	mov	dptr,#_ser_printString_String_65536_25
	movx	@dptr,a
	mov	a,r6
	inc	dptr
	movx	@dptr,a
...
;------------------------------------------------------------
;ret                       Allocated with name '_ser_charAvail_ret_65536_29'
;------------------------------------------------------------
...
;	_ser.c:175: char ret = 0;
	mov	dptr,#_ser_charAvail_ret_65536_29
	clr	a
	movx	@dptr,a
