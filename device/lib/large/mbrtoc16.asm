...
;	mbrtoc16.c:50: *pc16 = ps->c[1] + (ps->c[2] << 8);
	mov	dptr,#_mbrtoc16_PARM_4
	movx	a,@dptr
	mov	_mbrtoc16_sloc1_1_0,a
	inc	dptr
	movx	a,@dptr
	mov	(_mbrtoc16_sloc1_1_0 + 1),a
	inc	dptr
	movx	a,@dptr
	mov	(_mbrtoc16_sloc1_1_0 + 2),a
	mov	a,#0x01
	add	a,_mbrtoc16_sloc1_1_0
	mov	r2,a
	clr	a
	addc	a,(_mbrtoc16_sloc1_1_0 + 1)
	mov	r3,a
	mov	r4,(_mbrtoc16_sloc1_1_0 + 2)
	mov	dpl,r2
	mov	dph,r3
	mov	b,r4
	lcall	__gptrget
...
;	mbrtoc16.c:51: ps->c[1] = ps->c[2] = 0;
	...
	addc	a,(_mbrtoc16_sloc1_1_0 + 1)
	mov	(_mbrtoc16_sloc0_1_0 + 1),a
	mov	(_mbrtoc16_sloc0_1_0 + 2),(_mbrtoc16_sloc1_1_0 + 2)
	mov	a,#0x02
	add	a,_mbrtoc16_sloc1_1_0
	mov	r2,a
	clr	a
...
;	mbrtoc16.c:63: *pc16 = codepoint;
	mov	ar0,r2
	mov	ar1,r3
	mov	dpl,_mbrtoc16_sloc1_1_0
	mov	dph,(_mbrtoc16_sloc1_1_0 + 1)
	mov	b,(_mbrtoc16_sloc1_1_0 + 2)
	mov	a,r0
	lcall	__gptrput
	inc	dptr
	mov	a,r1
...
;	mbrtoc16.c:70: low_surrogate = (codepoint & 0x3ff) + 0xdc00;
	...
	movx	a,@dptr
	anl	ar3,#0x03
	mov	dptr,#_mbrtoc16_low_surrogate_65536_16
	mov	a,r2
	movx	@dptr,a
	mov	a,#0xdc
	add	a,r3
