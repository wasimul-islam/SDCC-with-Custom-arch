...
___stdc_first_leading_one:
	...
	push	dph
	push	dpl
	mov	dptr,#___stdc_first_leading_one_value_65536_8
	pop	acc
	movx	@dptr,a
	pop	acc
	inc	dptr
...
;	__stdc_first_leading_one.c:38: for(int_fast8_t i = width - 1; i >= 0; i--)
	mov	dptr,#___stdc_first_leading_one_PARM_2
	movx	a,@dptr
	mov	r7,a
	dec	a
	...
	mov	dptr,#___stdc_first_leading_one_value_65536_8
	movx	a,@dptr
	mov	___stdc_first_leading_one_sloc0_1_0,a
	inc	dptr
	movx	a,@dptr
	mov	(___stdc_first_leading_one_sloc0_1_0 + 1),a
	inc	dptr
	movx	a,@dptr
	mov	(___stdc_first_leading_one_sloc0_1_0 + 2),a
	inc	dptr
	movx	a,@dptr
	mov	(___stdc_first_leading_one_sloc0_1_0 + 3),a
	inc	dptr
	movx	a,@dptr
	mov	(___stdc_first_leading_one_sloc0_1_0 + 4),a
	inc	dptr
	movx	a,@dptr
	mov	(___stdc_first_leading_one_sloc0_1_0 + 5),a
	inc	dptr
	movx	a,@dptr
	mov	(___stdc_first_leading_one_sloc0_1_0 + 6),a
	inc	dptr
	movx	a,@dptr
	mov	(___stdc_first_leading_one_sloc0_1_0 + 7),a
00105$:
	mov	a,___stdc_first_leading_one_sloc1_1_0
	jb	acc.7,00103$
;	__stdc_first_leading_one.c:39: if(value & (1ull << i))
	push	ar7
	mov	r5,___stdc_first_leading_one_sloc1_1_0
	mov	b,r5
	inc	b
	mov	r0,#0x01
	mov	r1,#0x00
...
00123$:
	...
	anl	ar0,a
	mov	a,(___stdc_first_leading_one_sloc0_1_0 + 1)
	anl	ar1,a
	mov	a,(___stdc_first_leading_one_sloc0_1_0 + 2)
	anl	ar2,a
	mov	a,(___stdc_first_leading_one_sloc0_1_0 + 3)
	anl	ar3,a
	mov	a,(___stdc_first_leading_one_sloc0_1_0 + 4)
	anl	ar4,a
	mov	a,(___stdc_first_leading_one_sloc0_1_0 + 5)
	anl	ar5,a
	mov	a,(___stdc_first_leading_one_sloc0_1_0 + 6)
	anl	ar6,a
	mov	a,(___stdc_first_leading_one_sloc0_1_0 + 7)
	anl	ar7,a
	mov	a,r0
	orl	a,r1
	orl	a,r2
...
;	__stdc_first_leading_one.c:40: return (width - i);
	mov	a,r7
	clr	c
	subb	a,___stdc_first_leading_one_sloc1_1_0
	mov	dpl,a
	ret
00106$:
;	__stdc_first_leading_one.c:38: for(int_fast8_t i = width - 1; i >= 0; i--)
	dec	___stdc_first_leading_one_sloc1_1_0
	sjmp	00105$
00103$:
