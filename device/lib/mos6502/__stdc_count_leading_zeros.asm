...
;	../__stdc_count_leading_zeros.c: 38: for(int_fast8_t i = width - 1; i >= 0; i--)
	...
	sec
	sbc	#0x01
	sta	___stdc_count_leading_zeros_i_131072_10
	ldx	___stdc_count_leading_zeros_i_131072_10
00105$:
	txa
	sec
	sbc	#0x00
...
;	../__stdc_count_leading_zeros.c: 39: if(value & (1ull << i))
	...
	lda	*(__TEMP+0)
	jsr	__rlulonglong
	sta	*___stdc_count_leading_zeros_sloc1_1_0
	stx	*(___stdc_count_leading_zeros_sloc1_1_0 + 1)
	lda	*___SDCC_m6502_ret2
	sta	*(___stdc_count_leading_zeros_sloc1_1_0 + 2)
	lda	*___SDCC_m6502_ret3
	sta	*(___stdc_count_leading_zeros_sloc1_1_0 + 3)
	lda	*___SDCC_m6502_ret4
	sta	*(___stdc_count_leading_zeros_sloc1_1_0 + 4)
	lda	*___SDCC_m6502_ret5
	sta	*(___stdc_count_leading_zeros_sloc1_1_0 + 5)
	lda	*___SDCC_m6502_ret6
	sta	*(___stdc_count_leading_zeros_sloc1_1_0 + 6)
	lda	*___SDCC_m6502_ret7
	sta	*(___stdc_count_leading_zeros_sloc1_1_0 + 7)
	sta	*(__TEMP+0)
	pla
	tax
	lda	*___stdc_count_leading_zeros_sloc1_1_0
	and	___stdc_count_leading_zeros_PARM_1
	bne	00124$
	lda	*(___stdc_count_leading_zeros_sloc1_1_0 + 1)
	and	(___stdc_count_leading_zeros_PARM_1 + 1)
	bne	00124$
	lda	*(___stdc_count_leading_zeros_sloc1_1_0 + 2)
	and	(___stdc_count_leading_zeros_PARM_1 + 2)
	bne	00124$
	lda	*(___stdc_count_leading_zeros_sloc1_1_0 + 3)
	and	(___stdc_count_leading_zeros_PARM_1 + 3)
	bne	00124$
	lda	*(___stdc_count_leading_zeros_sloc1_1_0 + 4)
	and	(___stdc_count_leading_zeros_PARM_1 + 4)
	bne	00124$
	lda	*(___stdc_count_leading_zeros_sloc1_1_0 + 5)
	and	(___stdc_count_leading_zeros_PARM_1 + 5)
	bne	00124$
	lda	*(___stdc_count_leading_zeros_sloc1_1_0 + 6)
	and	(___stdc_count_leading_zeros_PARM_1 + 6)
	bne	00124$
	lda	*(___stdc_count_leading_zeros_sloc1_1_0 + 7)
	and	(___stdc_count_leading_zeros_PARM_1 + 7)
00124$:
	beq	00106$
;	../__stdc_count_leading_zeros.c: 40: return (width - i - 1);
	lda	*___stdc_count_leading_zeros_sloc0_1_0
	sec
	sbc	___stdc_count_leading_zeros_i_131072_10
	sec
	sbc	#0x01
	rts
00106$:
;	../__stdc_count_leading_zeros.c: 38: for(int_fast8_t i = width - 1; i >= 0; i--)
	dex
	stx	___stdc_count_leading_zeros_i_131072_10
	jmp	00105$
00103$:
