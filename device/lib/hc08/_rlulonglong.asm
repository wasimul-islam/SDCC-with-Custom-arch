...
;../_rlulonglong.c:53: b[1] = b[2];
	ldx	(__rlulonglong_PARM_1 + 0x0004)
	lda	((__rlulonglong_PARM_1 + 0x0004) + 1)
	stx	(__rlulonglong_PARM_1 + 0x0002)
	sta	((__rlulonglong_PARM_1 + 0x0002) + 1)
;../_rlulonglong.c:54: b[2] = b[3];
	ldx	(__rlulonglong_PARM_1 + 0x0006)
	lda	((__rlulonglong_PARM_1 + 0x0006) + 1)
	stx	(__rlulonglong_PARM_1 + 0x0004)
