...
;../_fsdiv.c:300: mant2 = MANT (fl2.l);
	...
	ldhx	#___fsdiv_org_mant2_65536_21
	mov	*___fsdiv_org_sloc2_1_0,x+
	mov	*(___fsdiv_org_sloc2_1_0 + 1),x+
	mov	*(___fsdiv_org_sloc2_1_0 + 2),x+
	mov	*(___fsdiv_org_sloc2_1_0 + 3),x+
...
;../_fsdiv.c:305: mask = 0x1000000;
	ldhx	#___fsdiv_org_mask_65536_21
	clra
	sta	1,x
	sta	2,x
	sta	3,x
...
;../_fsdiv.c:326: long diff = mant1 - mant2;
	...
	sta	*___fsdiv_org_sloc0_1_0
	ldhx	#___fsdiv_org_diff_196608_26
	mov	*___fsdiv_org_sloc0_1_0,x+
	mov	*(___fsdiv_org_sloc0_1_0 + 1),x+
	mov	*(___fsdiv_org_sloc0_1_0 + 2),x+
	mov	*(___fsdiv_org_sloc0_1_0 + 3),x+
