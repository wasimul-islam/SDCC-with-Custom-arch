...
;../__stdc_count_onesull.c:41: if(value & (1ull << i))
	...
	pshx
	jsr	__rlulonglong
	sta	*(___stdc_count_onesull_sloc0_1_0 + 7)
	stx	*(___stdc_count_onesull_sloc0_1_0 + 6)
	mov	*___SDCC_hc08_ret2,*(___stdc_count_onesull_sloc0_1_0 + 5)
	mov	*___SDCC_hc08_ret3,*(___stdc_count_onesull_sloc0_1_0 + 4)
	mov	*___SDCC_hc08_ret4,*(___stdc_count_onesull_sloc0_1_0 + 3)
	mov	*___SDCC_hc08_ret5,*(___stdc_count_onesull_sloc0_1_0 + 2)
	mov	*___SDCC_hc08_ret6,*(___stdc_count_onesull_sloc0_1_0 + 1)
	mov	*___SDCC_hc08_ret7,*___stdc_count_onesull_sloc0_1_0
	pulx
	lda	(___stdc_count_onesull_PARM_1 + 7)
	bit	*(___stdc_count_onesull_sloc0_1_0 + 7)
	bne	00126$
	lda	(___stdc_count_onesull_PARM_1 + 6)
	bit	*(___stdc_count_onesull_sloc0_1_0 + 6)
	bne	00126$
	lda	(___stdc_count_onesull_PARM_1 + 5)
	bit	*(___stdc_count_onesull_sloc0_1_0 + 5)
	bne	00126$
	lda	(___stdc_count_onesull_PARM_1 + 4)
	bit	*(___stdc_count_onesull_sloc0_1_0 + 4)
	bne	00126$
	lda	(___stdc_count_onesull_PARM_1 + 3)
	bit	*(___stdc_count_onesull_sloc0_1_0 + 3)
	bne	00126$
	lda	(___stdc_count_onesull_PARM_1 + 2)
	bit	*(___stdc_count_onesull_sloc0_1_0 + 2)
	bne	00126$
	lda	(___stdc_count_onesull_PARM_1 + 1)
	bit	*(___stdc_count_onesull_sloc0_1_0 + 1)
	bne	00126$
	lda	___stdc_count_onesull_PARM_1
	bit	*___stdc_count_onesull_sloc0_1_0
00126$:
	pula
	beq	00106$
