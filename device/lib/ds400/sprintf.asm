...
;buf                       Allocated with name '_vsprintf_buf_65536_63'
...
_vsprintf:
	mov     dps, #1
	mov     dptr, #_vsprintf_buf_65536_63
	mov	a,dpl
	movx	@dptr,a
	inc	dptr
	mov	a,dph
...
;	genAssign: resultIsFar = TRUE
	...
	mov	a,#_vsprintf_buf_65536_63
	movx	@dptr,a
	inc	dptr
	mov	a,#(_vsprintf_buf_65536_63 >> 8)
	movx	@dptr,a
	inc	dptr
	mov	a,#(_vsprintf_buf_65536_63 >> 16)
	movx	@dptr,a
	inc	dptr
	clr	a
	movx	@dptr,a
