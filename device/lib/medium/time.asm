...
_asctime:
	...
	mov	r6,dph
	mov	a,dpl
	mov	r0,#_asctime_timeptr_65536_28
	movx	@r0,a
	mov	a,r6
	inc	r0
	movx	@r0,a
...
_mktime:
	...
	mov	r6,dph
	mov	a,dpl
	mov	r0,#_mktime_timeptr_65536_45
	movx	@r0,a
	mov	a,r6
	inc	r0
	movx	@r0,a
...
;	time.c:189: for (i=1970; i<year; i++) {
	...
	sjmp	00110$
00124$:
	mov	_mktime_sloc1_1_0,r2
	mov	(_mktime_sloc1_1_0 + 1),r3
	mov	(_mktime_sloc1_1_0 + 2),r4
	mov	(_mktime_sloc1_1_0 + 3),r7
...
;	time.c:206: seconds+= timeptr->tm_min*60;
	...
	mov	r5,a
	mov	r4,a
	mov	r0,#_mktime_seconds_65536_46
	mov	a,r6
	add	a,_mktime_sloc1_1_0
	movx	@r0,a
	mov	a,r7
