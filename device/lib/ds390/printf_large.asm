...
_output_float_PARM_7:
	.ds 1
_output_float_f_65536_75:
	.ds 4
_output_float_fpBuffer_65536_76:
	.ds 128
_output_float_negative_65536_76:
	.ds 1
_output_float_decimalPart_65536_76:
	.ds 4
_output_float_exp_65536_76:
	.ds 1
...
__print_format_PARM_4:
	.ds 4
__print_format_left_justify_65536_113:
	.ds 1
__print_format_zero_padding_65536_113:
	.ds 1
__print_format_prefix_sign_65536_113:
	.ds 1
__print_format_prefix_space_65536_113:
	.ds 1
__print_format_signed_argument_65536_113:
	.ds 1
__print_format_char_argument_65536_113:
	.ds 1
__print_format_long_argument_65536_113:
	.ds 1
__print_format_float_argument_65536_113:
	.ds 1
__print_format_radix_65536_113:
	.ds 1
__print_format_decimals_65536_113:
	.ds 2
...
;b4                        Allocated with name '_calculate_digit_b4_65536_72'
...
;	printf_large.c:197: b4 = (b4 << 1);
	...
	mov	a,r1
	add	a,acc
	mov	_calculate_digit_b4_65536_72,a
;	printf_large.c:198: b4 |= (ul >> 31) & 0x01;
	mov	a,r6
	rl	a
	anl	a,#0x01
	mov  r1,a
	orl	a,_calculate_digit_b4_65536_72
	mov	r7,a
...
;f                         Allocated with name '_output_float_f_65536_75'
;fpBuffer                  Allocated with name '_output_float_fpBuffer_65536_76'
;negative                  Allocated with name '_output_float_negative_65536_76'
;integerPart               Allocated to registers r2 r3 r4 r5 
;rounding                  Allocated to registers r0 r1 r7 r6 
;decimalPart               Allocated with name '_output_float_decimalPart_65536_76'
;fpBI                      Allocated to registers r6 
;fpBD                      Allocated to registers 
;minWidth                  Allocated to registers r2 
;i                         Allocated to registers 
;exp                       Allocated with name '_output_float_exp_65536_76'
...
;	genAssign: resultIsFar = TRUE
	mov	dptr,#_output_float_negative_65536_76
	clr	a
	movx	@dptr,a
;	printf_large.c:253: signed char exp = -128;
;	genAssign: resultIsFar = TRUE
	mov	dptr,#_output_float_exp_65536_76
	mov	a,#0x80
	movx	@dptr,a
...
;	genAssign: resultIsFar = TRUE
	...
	mov	r5,b
;	genAssign: resultIsFar = TRUE
	mov	dptr,#_output_float_f_65536_75
	mov	a,r2
	movx	@dptr,a
	inc	dptr
	mov	a,r3
...
;	genAssign: resultIsFar = FALSE
	...
	mov	dptr,#_output_float_sloc1_1_0
	mov	a,r2
	add	a,#_output_float_fpBuffer_65536_76
	movx	@dptr,a
	clr	a
	addc	a,#(_output_float_fpBuffer_65536_76 >> 8)
	inc	dptr
	movx	@dptr,a
	clr	a
	addc	a,#(_output_float_fpBuffer_65536_76 >> 16)
	inc	dptr
	movx	@dptr,a
;	genAssign: resultIsFar = TRUE
...
;	genAssign: resultIsFar = TRUE
	...
	pop	ar6
;	genAssign: resultIsFar = TRUE
	mov	dptr,#_output_float_decimalPart_65536_76
	mov	a,r2
	movx	@dptr,a
	inc	dptr
	mov	a,r3
...
;left_justify              Allocated with name '__print_format_left_justify_65536_113'
;zero_padding              Allocated with name '__print_format_zero_padding_65536_113'
;prefix_sign               Allocated with name '__print_format_prefix_sign_65536_113'
;prefix_space              Allocated with name '__print_format_prefix_space_65536_113'
;signed_argument           Allocated with name '__print_format_signed_argument_65536_113'
;char_argument             Allocated with name '__print_format_char_argument_65536_113'
;long_argument             Allocated with name '__print_format_long_argument_65536_113'
;float_argument            Allocated with name '__print_format_float_argument_65536_113'
;lsd                       Allocated to registers r2 
;radix                     Allocated with name '__print_format_radix_65536_113'
;width                     Allocated to registers 
;decimals                  Allocated with name '__print_format_decimals_65536_113'
...
;	genAssign: resultIsFar = TRUE
	mov	dptr,#__print_format_left_justify_65536_113
...
;	genAssign: resultIsFar = TRUE
	clr   a
	movx  @dptr,a
	mov   dptr,#__print_format_zero_padding_65536_113
	movx  @dptr,a
	mov   dptr,#__print_format_prefix_sign_65536_113
	movx  @dptr,a
	mov   dptr,#__print_format_prefix_space_65536_113
	movx  @dptr,a
;	printf_large.c:483: signed_argument = 0;
;	genAssign: resultIsFar = TRUE
	mov	dptr,#__print_format_signed_argument_65536_113
...
;	genAssign: resultIsFar = TRUE
	clr   a
	movx  @dptr,a
	mov   dptr,#__print_format_char_argument_65536_113
	movx  @dptr,a
	mov   dptr,#__print_format_long_argument_65536_113
	movx  @dptr,a
	mov   dptr,#__print_format_float_argument_65536_113
	movx  @dptr,a
;	printf_large.c:487: radix           = 0;
;	genAssign: resultIsFar = TRUE
	mov	dptr,#__print_format_radix_65536_113
...
;	genAssign: resultIsFar = TRUE
	mov	dptr,#__print_format_decimals_65536_113
	mov  a,#0xff
	movx @dptr,a
	inc  dptr
	movx @dptr,a
...
;	genAssign: resultIsFar = FALSE
	mov	r5,#(__print_format_store_262144_135 + 0x000005)
	mov	r6,#((__print_format_store_262144_135 + 0x000005) >> 8)
	mov	r7,#((__print_format_store_262144_135 + 0x000005) >> 16)
;	genAssign: resultIsFar = TRUE
