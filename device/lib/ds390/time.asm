...
_time:
	mov     dps, #1
	mov     dptr, #_time_timeptr_65536_19
	mov	a,dpl
	movx	@dptr,a
	inc	dptr
	mov	a,dph
...
_asctime:
	mov     dps, #1
	mov     dptr, #_asctime_timeptr_65536_25
	mov	a,dpl
	movx	@dptr,a
	inc	dptr
	mov	a,dph
...
_mktime:
	mov     dps, #1
	mov     dptr, #_mktime_timeptr_65536_42
	mov	a,dpl
	movx	@dptr,a
	inc	dptr
	mov	a,dph
...
;	time.c:180: int year=timeptr->tm_year+1900, month=timeptr->tm_mon, i;
	...
	lcall	__gptrget
	mov  r0,a
	mov  dptr,#_mktime_month_65536_43
	movx @dptr,a
	inc	dptr
	clr	a
	movx	@dptr,a
