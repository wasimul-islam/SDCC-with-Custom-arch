...
_strncat_PARM_3:
	.ds 2
_strncat_front_65536_27:
	.ds 4
_strncat_start_65536_28:
	.ds 4
_strncat_sloc0_1_0:
	.ds 4
;--------------------------------------------------------
...
;front                     Allocated with name '_strncat_front_65536_27'
;start                     Allocated with name '_strncat_start_65536_28'
...
;	genAssign: resultIsFar = TRUE
	mov	dptr,#_strncat_start_65536_28
	mov	a,r2
	movx	@dptr,a
	inc	dptr
	mov	a,r3
...
00138$:
;	genAssign: resultIsFar = TRUE
	mov	dptr,#_strncat_front_65536_27
	mov	a,r2
	movx	@dptr,a
	inc	dptr
	mov	a,r3
