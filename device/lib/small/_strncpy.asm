...
;	_strncpy.c:35: register char * d1 =  d;
	mov	_strncpy_d1_65536_27,r5
	mov	(_strncpy_d1_65536_27 + 1),r6
	mov	(_strncpy_d1_65536_27 + 2),r7
...
;	_strncpy.c:40: *d++ = *s++ ;
	...
	clr	a
	cjne	a,_strncpy_sloc0_1_0,00135$
...
;	_strncpy.c:46: return d1;
	mov	dpl,_strncpy_d1_65536_27
	mov	dph,(_strncpy_d1_65536_27 + 1)
	mov	b,(_strncpy_d1_65536_27 + 2)
;	_strncpy.c:47: }
	ret
	.area CSEG    (CODE)
	.area CONST   (CODE)
