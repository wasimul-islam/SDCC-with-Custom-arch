...
_memcmp:
	...
	ar1 = 0x01
	ar0 = 0x00
	mov	_memcmp_buf1_65536_26,dpl
	mov	(_memcmp_buf1_65536_26 + 1),dph
	mov	(_memcmp_buf1_65536_26 + 2),b
...
00127$:
	...
	orl	a,r4
	jz	00106$
	mov	r0,_memcmp_buf1_65536_26
	mov	r1,(_memcmp_buf1_65536_26 + 1)
	mov	r2,(_memcmp_buf1_65536_26 + 2)
	mov	dpl,r0
	mov	dph,r1
	mov	b,r2
	lcall	__gptrget
...
;	_memcmp.c:37: buf1 = (char *)buf1 + 1;
	...
	inc	r1
00131$:
	mov	_memcmp_buf1_65536_26,r0
	mov	(_memcmp_buf1_65536_26 + 1),r1
	mov	(_memcmp_buf1_65536_26 + 2),r2
...
;	_memcmp.c:41: return( *((unsigned char *)buf1) - *((unsigned char *)buf2) );
	mov	r5,_memcmp_buf1_65536_26
	mov	r6,(_memcmp_buf1_65536_26 + 1)
	mov	r7,(_memcmp_buf1_65536_26 + 2)
	mov	dpl,r5
	mov	dph,r6
	mov	b,r7
	lcall	__gptrget
