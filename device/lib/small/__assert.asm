...
;expression                Allocated to registers r5 r6 r7 
;------------------------------------------------------------
...
;	__assert.c:34: printf("Assert(%s) failed in function %s at line %u in file %s.\n",
	push	___assert_PARM_3
	push	(___assert_PARM_3 + 1)
	push	(___assert_PARM_3 + 2)
	push	___assert_PARM_4
	push	(___assert_PARM_4 + 1)
	push	___assert_PARM_2
	push	(___assert_PARM_2 + 1)
	push	(___assert_PARM_2 + 2)
	push	ar5
	push	ar6
	push	ar7
	mov	a,#___str_0
