...
_atan2f:
	...
	ar1 = 0x01
	ar0 = 0x00
	mov	_atan2f_x_65536_25,dpl
	mov	(_atan2f_x_65536_25 + 1),dph
	mov	(_atan2f_x_65536_25 + 2),b
	mov	(_atan2f_x_65536_25 + 3),a
;	atan2f.c:38: if ((x==0.0) && (y==0.0))
	mov	b,_atan2f_x_65536_25
	mov	a,(_atan2f_x_65536_25 + 1)
	orl	b,a
	mov	a,(_atan2f_x_65536_25 + 2)
	orl	b,a
	mov	a,(_atan2f_x_65536_25 + 3)
	anl	a,#0x7F
	orl	a,b
	jnz	00102$
...
;	atan2f.c:44: if(fabsf(y)>=fabsf(x))
	...
	mov	r2,b
	mov	r3,a
	mov	dpl,_atan2f_x_65536_25
	mov	dph,(_atan2f_x_65536_25 + 1)
	mov	b,(_atan2f_x_65536_25 + 2)
	mov	a,(_atan2f_x_65536_25 + 3)
	push	ar3
	push	ar2
	push	ar1
...
;	atan2f.c:51: r=-atanf(y/x);
	push	_atan2f_x_65536_25
	push	(_atan2f_x_65536_25 + 1)
	push	(_atan2f_x_65536_25 + 2)
	push	(_atan2f_x_65536_25 + 3)
	mov	dpl,_atan2f_PARM_2
	mov	dph,(_atan2f_PARM_2 + 1)
	mov	b,(_atan2f_PARM_2 + 2)
	mov	a,(_atan2f_PARM_2 + 3)
	...
	mov	r2,b
	mov	r3,a
	mov	_atan2f_r_65536_26,r0
	mov	(_atan2f_r_65536_26 + 1),r1
	mov	(_atan2f_r_65536_26 + 2),r2
	mov	a,r3
	cpl	acc.7
	mov	(_atan2f_r_65536_26 + 3),a
...
00114$:
	...
	push	ar2
	push	ar3
	mov	dpl,_atan2f_r_65536_26
	mov	dph,(_atan2f_r_65536_26 + 1)
	mov	b,(_atan2f_r_65536_26 + 2)
	mov	a,(_atan2f_r_65536_26 + 3)
	lcall	___fsadd
	mov	r4,dpl
	mov	r5,dph
	mov	r6,b
