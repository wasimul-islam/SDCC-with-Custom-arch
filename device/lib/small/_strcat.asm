...
_strcat:
	...
	ar1 = 0x01
	ar0 = 0x00
	mov	_strcat_dst_65536_26,dpl
	mov	(_strcat_dst_65536_26 + 1),dph
	mov	(_strcat_dst_65536_26 + 2),b
;	_strcat.c:35: while( *cp )
	mov	r2,_strcat_dst_65536_26
	mov	r3,(_strcat_dst_65536_26 + 1)
	mov	r4,(_strcat_dst_65536_26 + 2)
00101$:
	mov	dpl,r2
	mov	dph,r3
	mov	b,r4
...
;	_strcat.c:40: return( dst );                  /* return dst */
	mov	dpl,_strcat_dst_65536_26
	mov	dph,(_strcat_dst_65536_26 + 1)
	mov	b,(_strcat_dst_65536_26 + 2)
;	_strcat.c:41: }
	ret
	.area CSEG    (CODE)
	.area CONST   (CODE)
