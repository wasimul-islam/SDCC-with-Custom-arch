...
_frexpf:
	...
	mov	r7,a
;	frexpf.c:39: fl.f=x;
	mov	(_frexpf_fl_65536_26 + 0),r4
	mov	(_frexpf_fl_65536_26 + 1),r5
	mov	(_frexpf_fl_65536_26 + 2),r6
	mov	(_frexpf_fl_65536_26 + 3),r7
;	frexpf.c:41: i  = ( fl.l >> 23) & 0x000000ff;
	mov	r4,(_frexpf_fl_65536_26 + 2)
...
;	frexpf.c:42: i -= 0x7e;
	...
	mov	a,r4
	add	a,#0x82
	mov	_frexpf_i_65536_26,a
	mov	a,r5
	addc	a,#0xff
	mov	(_frexpf_i_65536_26 + 1),a
	mov	a,r6
	addc	a,#0xff
	mov	(_frexpf_i_65536_26 + 2),a
	mov	a,r7
	addc	a,#0xff
	mov	(_frexpf_i_65536_26 + 3),a
;	frexpf.c:43: *pw2 = i;
	mov	r2,_frexpf_PARM_2
	mov	r3,(_frexpf_PARM_2 + 1)
	mov	r7,(_frexpf_PARM_2 + 2)
	mov	r4,_frexpf_i_65536_26
	mov	r5,(_frexpf_i_65536_26 + 1)
	mov	dpl,r2
	mov	dph,r3
	mov	b,r7
	mov	a,r4
...
;	frexpf.c:44: fl.l &= 0x807fffff; /* strip all exponent bits */
	mov	r4,_frexpf_fl_65536_26
	mov	r5,(_frexpf_fl_65536_26 + 1)
	mov	a,#0x7f
	anl	a,(_frexpf_fl_65536_26 + 2)
	mov	r6,a
	mov	a,#0x80
	anl	a,(_frexpf_fl_65536_26 + 3)
	mov	r7,a
	mov	(_frexpf_fl_65536_26 + 0),r4
	mov	(_frexpf_fl_65536_26 + 1),r5
	mov	(_frexpf_fl_65536_26 + 2),r6
...
;	frexpf.c:46: return(fl.f);
	mov	dpl,_frexpf_fl_65536_26
	mov	dph,(_frexpf_fl_65536_26 + 1)
	mov	b,(_frexpf_fl_65536_26 + 2)
	mov	a,(_frexpf_fl_65536_26 + 3)
;	frexpf.c:47: }
	ret
	.area CSEG    (CODE)
