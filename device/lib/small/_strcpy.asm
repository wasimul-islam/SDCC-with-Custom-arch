...
_strcpy:
	...
	ar1 = 0x01
	ar0 = 0x00
	mov	_strcpy_d_65536_26,dpl
	mov	(_strcpy_d_65536_26 + 1),dph
	mov	(_strcpy_d_65536_26 + 2),b
;	_strcpy.c:48: while (*d1++ = *s++) ;
	mov	r2,_strcpy_PARM_2
	mov	r3,(_strcpy_PARM_2 + 1)
	mov	r4,(_strcpy_PARM_2 + 2)
	mov	r0,_strcpy_d_65536_26
	mov	r1,(_strcpy_d_65536_26 + 1)
	mov	r7,(_strcpy_d_65536_26 + 2)
00101$:
	mov	dpl,r2
	mov	dph,r3
	mov	b,r4
...
;	_strcpy.c:50: return d;
	mov	dpl,_strcpy_d_65536_26
	mov	dph,(_strcpy_d_65536_26 + 1)
	mov	b,(_strcpy_d_65536_26 + 2)
;	_strcpy.c:52: }
	ret
	.area CSEG    (CODE)
	.area CONST   (CODE)
