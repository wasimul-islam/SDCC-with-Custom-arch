...
;buf                       Allocated with name '_vsprintf_buf_65536_16'
...
;	-----------------------------------------
_vsprintf:
	mov	_vsprintf_buf_65536_16,dpl
	mov	(_vsprintf_buf_65536_16 + 1),dph
	mov	(_vsprintf_buf_65536_16 + 2),b
;	sprintf.c:44: i = _print_format (put_char_to_string, &buf, format, ap);
	mov	__print_format_PARM_2,#_vsprintf_buf_65536_16
	...
	mov	r7,dph
;	sprintf.c:45: *buf = 0;
	mov	r3,_vsprintf_buf_65536_16
	mov	r4,(_vsprintf_buf_65536_16 + 1)
	mov	r5,(_vsprintf_buf_65536_16 + 2)
	mov	dpl,r3
	mov	dph,r4
	mov	b,r5
	clr	a
