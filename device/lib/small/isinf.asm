...
_isinf:
	...
	ar1 = 0x01
	ar0 = 0x00
	mov	_isinf_f_65536_44,dpl
	mov	(_isinf_f_65536_44 + 1),dph
	mov	(_isinf_f_65536_44 + 2),b
	mov	(_isinf_f_65536_44 + 3),a
;	isinf.c:35: unsigned long *pl = (unsigned long *) &f;
;	isinf.c:36: return *pl == 0x7f800000 || *pl == 0xff800000;
	mov	r4,(_isinf_f_65536_44 + 0)
	mov	r5,(_isinf_f_65536_44 + 1)
	mov	r6,(_isinf_f_65536_44 + 2)
	mov	r7,(_isinf_f_65536_44 + 3)
	cjne	r4,#0x00,00114$
	cjne	r5,#0x00,00114$
	cjne	r6,#0x80,00114$
	cjne	r7,#0x7f,00114$
