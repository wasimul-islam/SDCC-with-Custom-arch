...
;	c32rtomb.c:36: return(wctomb(s, c32));
	mov	_wctomb_PARM_2,_c32rtomb_PARM_2
	mov	(_wctomb_PARM_2 + 1),(_c32rtomb_PARM_2 + 1)
	mov	(_wctomb_PARM_2 + 2),(_c32rtomb_PARM_2 + 2)
	mov	(_wctomb_PARM_2 + 3),(_c32rtomb_PARM_2 + 3)
	mov	dpl,r5
	mov	dph,r6
	mov	b,r7
;	c32rtomb.c:37: }
