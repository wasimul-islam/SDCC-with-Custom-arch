...
;../mbrtoc32.c:41: ps = &sps;
	ldhx	#_mbrtoc32_sps_65536_16
	sthx	_mbrtoc32_PARM_4
00102$:
;../mbrtoc32.c:44: return(mbrtowc(0, s, n, ps));
	ldhx	_mbrtoc32_PARM_2
	sthx	*_mbrtoc32_sloc0_1_0
	ldhx	_mbrtoc32_PARM_3
	sthx	*_mbrtoc32_sloc1_1_0
	ldhx	_mbrtoc32_PARM_4
