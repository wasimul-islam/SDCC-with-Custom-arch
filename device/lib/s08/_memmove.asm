...
00119$:
	sthx	*_memmove_sloc3_1_0
	mov	*_memmove_sloc0_1_0,*_memmove_sloc2_1_0
	mov	*(_memmove_sloc0_1_0 + 1),*(_memmove_sloc2_1_0 + 1)
	ldhx	_memmove_c_65536_27
00107$:
;../_memmove.c:60: *d++ = *s++;
	pshx
