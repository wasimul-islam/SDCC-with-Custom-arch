...
_memset_explcit:
	sta	(_memset_explcit_s_65536_26 + 1)
	stx	_memset_explcit_s_65536_26
;../memset_explicit.c:34: return(memset(s, c, n));
	ldhx	_memset_explcit_PARM_2
	sthx	_memset_PARM_2
	ldhx	_memset_explcit_PARM_3
	sthx	_memset_PARM_3
	lda	(_memset_explcit_s_65536_26 + 1)
	ldx	_memset_explcit_s_65536_26
