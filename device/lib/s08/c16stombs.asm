...
;../c16stombs.c:56: codepoint = c16s[0];
	mov	*(___c16stombs_sloc1_1_0 + 1),*(___c16stombs_sloc2_1_0 + 3)
	mov	*___c16stombs_sloc1_1_0,*(___c16stombs_sloc2_1_0 + 2)
...
;../c16stombs.c:74: l = wctomb(b, codepoint);
	ldhx	___c16stombs_codepoint_196608_78
	sthx	_wctomb_PARM_2
	ldhx	(___c16stombs_codepoint_196608_78 + 2)
...
;../c16stombs.c:79: if(m + l > n)
	...
	sta	*___c16stombs_sloc3_1_0
	ldhx	*___c16stombs_sloc3_1_0
	cphx	___c16stombs_PARM_3
	bhi	00118$
