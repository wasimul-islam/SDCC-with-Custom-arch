...
void gennewSTM8Code (iCode *);
void newstm8_emitDebuggerSymbol (const char *);

bool newstm8IsReturned(const char *what);
...
bool newstm8IsRegArg(struct sym_link *ftype, int i, const char *what);

// Check if what is part of the any argument (counting from 1) to a function of type ftype.
bool newstm8IsParmInCall(sym_link *ftype, const char *what);

extern bool newstm8_assignment_optimal;
extern long int newstm8_call_stack_size;
extern bool newstm8_extend_stack;
