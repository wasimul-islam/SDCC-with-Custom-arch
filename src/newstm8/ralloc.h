...
extern reg_info newstm8_regs[];

void newstm8_assignRegisters (ebbIndex *);

void newstm8SpillThis (symbol *sym, bool force_spill);
iCode *newstm8_ralloc2_cc(ebbIndex *ebbi);

void newstm8RegFix (eBBlock ** ebbs, int count);
#endif
